import commonClasses from "./styles/Examples.module.css";
            ...
            <div className="main-container">
                ...
                >
                    <div className="chart-container">
                        ...
                        <SciChartReact className="chart-root" initChart={drawShaleChart} />
                    </div>
                    <div className="chart-container">
                        <div id="density-legend" className="legend-root"></div>
                        <SciChartReact className="chart-root" initChart={drawDensityChart} />
                    </div>
                    <div className="chart-container">
                        <div id="resistivity-legend" className="legend-root"></div>
                        <SciChartReact className="chart-root" initChart={drawResistivityChart} />
                    </div>
                    <div className="chart-container">
                        <div id="pore-space-legend" className="legend-root"></div>
                        <SciChartReact className="chart-root" initChart={drawPoreSpaceChart} />
                    </div>
                    <div className="chart-container">
                        <div id="sonic-legend" className="legend-root"></div>
                        <SciChartReact className="chart-root" initChart={drawSonicChart} />
                    </div>
                    <div className="chart-container">
                        <div id="texture-legend" className="legend-root"></div>
                        <SciChartReact className="chart-root" initChart={drawTextureChart} />
                    </div>
                </div>
            </div>
        </ChartGroupLoader>
