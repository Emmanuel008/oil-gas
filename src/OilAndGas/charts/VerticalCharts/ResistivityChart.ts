...
export const drawResistivityChart = async (rootElement: string | HTMLDivElement) => {
    ...
    const bandSeries = new FastBandRenderableSeries(wasmContext, {
        dataSeries,
        strokeThickness: 0,
        stroke: appTheme.ResistivityStroke,
        strokeY1: appTheme.ResistivityStroke,
        fill: appTheme.ResistivityFill,
        fillY1: appTheme.ResistivityFill,
    });
...
const generateResistivityLegend = (
    ...
    <div class="chart-legend">
        <div class="legend-color-item" style="height: 30px;">
            <div class="color-label" style="background-color: ${appTheme.ResistivityStroke};"></div>
        </div>
